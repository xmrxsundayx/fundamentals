...
user2 = user("Will", "Turner", "iloveelizabeth@palray.com", "28", False, 150)
user3 = user("Black", "Beard", "deathtocaptainjacksparrow@parlay.com", "50", True, 80)

user1.print_user_info().member_status().spend_points(50)
user2.print_user_info().member_status().spend_points(80)
user3.print_user_info().member_status().spend_points(40)